<?php
	include('../../controllers/Transaction/sentOrReceiveController.php');
?>
<!DOCTYPE html>
<html>
<head>
...
<body>
	<form method="POST" name="alex">
		<div class="w3-container" style="margin-top: 20px;">
			<div class="w3-cart w3-round-medium" style="margin-left: 200px;width: 1000px">
				<div class="">
					<center style="margin-top: 30px">
						<span class="w3-text-blue w3-xlarge">My Sent or Received Transactions</span>
					...
					<div style="margin-top: 30px;margin-left: 370px;">
						<table>
							...
							<tr>
								<td>
									<select class="w3-round-medium w3-dropdown" value="" name="select" id="select" style="height: 30px;width: 280px;">
						...
						<table class="w3-table-all w3-bordered">
							...
							<tr>
								...
								<td><?php if($amt == 0){echo "-";}else{echo number_format($amt,2);} ?></td>
							</tr>
							<?php $count += 1; } ?>
							...
							<tr>
								...
								<td><?php if($amt2 == 0){echo "-";}else{echo number_format($amt2,2);} ?></td>
							</tr>
							<?php $count += 1; } ?>
						</table>
				</div>
